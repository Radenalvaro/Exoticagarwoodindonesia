...
// FIXED: Include the correct component file for minyak gaharu
require_once 'components/productminyakgaharu.php';

try {
    // FIXED: Query for minyak_gaharu category instead of kayu_gaharu
    $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'minyak_gaharu' AND is_active = 1 ORDER BY grade, name");
    $stmt->execute();
    ...
    <section class="catalog">
        <div class="container">
            <div class="catalog-header">
                <h1>Catalog Agarwood Oil</h1>
                <p>Explore our exquisite collection of premium oud oils</p>
            </div>
