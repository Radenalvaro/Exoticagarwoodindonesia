...
// Get product data
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE id = ? AND category = 'minyak_gaharu'");
    ...
    if (empty($name) || empty($origin) || empty($grade) || empty($description) || $price <= 0) {
        ...
        if (isset($_FILES['product_image']) && $_FILES['product_image']['error'] === UPLOAD_ERR_OK) {
            ...
            if (!in_array($file_extension, $allowed_extensions)) {
                ...
                $new_filename = 'minyak_' . time() . '_' . uniqid() . '.' . $file_extension;
        ...
        if (empty($error_message)) {
            try {
                $stmt = $pdo->prepare("
                    UPDATE products 
                    SET name = ?, grade = ?, origin = ?, price = ?, unit = 'ml', description = ?, image_url = ?, stock_quantity = ?, updated_at = NOW()
                    WHERE id = ? AND category = 'minyak_gaharu'
                ");
                
                $result = $stmt->execute([$name, $grade, $origin, $price, $description, $image_url, $quantity, $product_id]);
                
                if ($result) {
                    $success_message = 'Produk minyak gaharu berhasil diupdate!';
...
<head>
    ...
    <title>Edit Minyak Gaharu - Admin Dashboard</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="admineai.php#minyak-section">
                <i class="fas fa-edit"></i>
                Edit Minyak Gaharu
            </a>
    ...
    <div class="main-content">
        ...
        <div class="top-navbar d-flex justify-content-between align-items-center">
            <h3 class="mb-0">Edit Produk Minyak Gaharu</h3>
        ...
        <div class="container-fluid">
            ...
            <div class="form-container">
                <h4 class="form-title">
                    <i class="fas fa-edit me-2"></i>Edit Minyak Gaharu: <?php echo htmlspecialchars($product['name']); ?>
                </h4>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="grade" name="grade" 
                                       ...
                                       placeholder="Contoh: Premium, Super Grade, dll" required>
                                <div class="form-text">Tulis grade sesuai keinginan Anda</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="quantity" class="form-label">Stok (mL)</label>
                                <input type="number" class="form-control" id="quantity" name="quantity" 
                                       value="<?php echo htmlspecialchars($product['stock_quantity']); ?>" min="0">
                                <div class="form-text">Masukkan jumlah stok dalam mililiter (mL)</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="file-upload-area" onclick="document.getElementById('product_image').click()">
                            ...
                            <div class="upload-text">
                                <strong>Klik untuk upload gambar baru</strong> atau drag & drop file di sini
                            </div>
                            <small class="text-muted">Format: JPG, PNG, GIF, WebP (Max: 5MB) - Kosongkan jika tidak ingin mengubah gambar</small>
                        </div>
