...
// Get product details - HANYA MINYAK GAHARU
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE id = ? AND category = 'minyak_gaharu' AND is_active = 1");
    $stmt->execute([$product_id]);
    $product = $stmt->fetch(PDO::FETCH_ASSOC);
    
    if (!$product) {
        header('Location: catalogminyakgaharu.php');
        exit;
    }
...
// Get related minyak gaharu products (same category, different product)
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'minyak_gaharu' AND id != ? AND is_active = 1 ORDER BY RAND() LIMIT 6");
    $stmt->execute([$product_id]);
...
// Get kayu gaharu products for cross-selling
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'kayu_gaharu' AND is_active = 1 ORDER BY RAND() LIMIT 6");
    $stmt->execute();
...
$main_image = 'https://images.unsplash.com/photo-1574263867128-a3d5c1b1deaa?w=600&h=600&fit=crop';
...
// FORCE UNIT TO ML untuk display di semua tempat
$display_unit = 'ml';
...
<head>
    ...
    <title><?php echo htmlspecialchars($product['name']); ?> - Agarwood Oil Detail | ExoticAgarwood Indonesia</title>
...
<body>
    ...
    <section class="product-detail">
        <div class="detail-container">
                ...
                <div class="image-gallery">
                    <div class="main-image">
                        <img src="<?php echo htmlspecialchars($main_image); ?>" 
                             ...
                             onerror="this.src='https://images.unsplash.com/photo-1574263867128-a3d5c1b1deaa?w=600&h=600&fit=crop'">
                    </div>
                </div>
                ...
                <div class="product-info">
                    ...
                    <div class="product-meta">
                        <div class="meta-item meta-category">
                            ...
                            <span class="meta-value">Agarwood Oil</span>
                        </div>
            ...
            <!-- Related Agarwood Oil Products -->
            <?php if (!empty($related_products)): ?>
            <div class="related-section">
                <h2 class="section-title">More Agarwood Oil Products</h2>
                <div class="related-grid">
                    <?php foreach ($related_products as $related): ?>
                    <?php
                    // FIXED PATH FOR ADMIN FOLDER
                    $related_image = 'https://images.unsplash.com/photo-1574263867128-a3d5c1b1deaa?w=300&h=300&fit=crop';
                    ...
                    <div class="related-card">
                        ...
                        <div class="related-info">
                            ...
                            <p class="related-price">$<?php echo number_format($related['price']); ?> / ml</p>
                            <a href="seedetail-minyakgaharu.php?id=<?php echo $related['id']; ?>" class="view-detail-btn">View Details</a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="related-section">
                <h2 class="section-title">Explore Our Agarwood Collection</h2>
                <div class="related-grid">
                    <?php foreach ($other_products as $other): ?>
                    <?php
                    // FIXED PATH FOR ADMIN FOLDER
                    $other_image = 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=300&h=300&fit=crop';
                    ...
                    <div class="related-card">
                        ...
                        <div class="related-info">
                            ...
                            <p class="related-price">$<?php echo number_format($other['price']); ?> / <?php echo htmlspecialchars($other['unit']); ?></p>
                            <a href="seedetail-kayugaharu.php?id=<?php echo $other['id']; ?>" class="view-detail-btn">View Details</a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
