...
// Get product data
try {
    $stmt = $pdo->prepare("SELECT * FROM products WHERE id = ? AND category = 'kayu_gaharu'");
    ...
    if (empty($name) || empty($origin) || empty($grade) || empty($description) || $price <= 0) {
        ...
        if (empty($error_message)) {
            try {
                $stmt = $pdo->prepare("
                    UPDATE products 
                    SET name = ?, grade = ?, origin = ?, price = ?, description = ?, image_url = ?, stock_quantity = ?, updated_at = NOW()
                    WHERE id = ? AND category = 'kayu_gaharu'
                ");
                
                $result = $stmt->execute([$name, $grade, $origin, $price, $description, $image_url, $quantity, $product_id]);
                
                if ($result) {
                    $success_message = 'Produk kayu gaharu berhasil diupdate!';
...
<head>
    ...
    <title>Edit Kayu Gaharu - Admin Dashboard</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="admineai.php#kayu-section">
    ...
    <div class="main-content">
        ...
        <div class="top-navbar d-flex justify-content-between align-items-center">
            <h3 class="mb-0">Edit Produk Kayu Gaharu</h3>
        ...
        <div class="container-fluid">
            ...
            <div class="form-container">
                <h4 class="form-title">
                    <i class="fas fa-edit me-2"></i>Edit Kayu Gaharu: <?php echo htmlspecialchars($product['name']); ?>
                </h4>
