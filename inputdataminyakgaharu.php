...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($origin) || empty($grade) || empty($description) || $price <= 0) {
        ...
        if (empty($error_message)) {
            try {
                $stmt = $pdo->prepare("
    INSERT INTO products (name, category, grade, origin, price, unit, description, image_url, stock_quantity, is_active, created_at, updated_at)
    VALUES (?, 'minyak_gaharu', ?, ?, ?, 'ml', ?, ?, ?, 1, NOW(), NOW())
");
                ...
                if ($result) {
                    $success_message = 'Produk minyak gaharu berhasil ditambahkan!';
                    // Reset form
                    $_POST = [];
                } else {
...
<head>
    ...
    <title>Tambah Minyak Gaharu - Admin Dashboard</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="inputdataminyakgaharu.php">
                <i class="fas fa-plus-circle"></i>
    ...
    <div class="main-content">
        ...
        <div class="top-navbar d-flex justify-content-between align-items-center">
            <h3 class="mb-0">Tambah Produk Minyak Gaharu</h3>
        ...
        <div class="container-fluid">
            ...
            <div class="form-container">
                <h4 class="form-title">
                    <i class="fas fa-plus-circle me-2"></i>Tambah Produk Minyak Gaharu Baru
                </h4>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" 
                                       ...
                                       placeholder="Contoh: Minyak Gaharu Premium Kalimantan" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="origin" name="origin" 
                                       ...
                                       placeholder="Contoh: Kalimantan, Indonesia" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="price" name="price" 
                                       ...
                                       placeholder="Contoh: 150.00" step="0.01" min="0" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="5" 
                                  placeholder="Jelaskan detail produk, kualitas, aroma, dan keunggulannya..." required><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
